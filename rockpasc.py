...
def ropasc():
    ...
    if user == "Rock" or "rock" or "ROCK" and computer == "Rock":
        print("The Game is Tie.")

    elif user == "Rock" or "rock" or "ROCK" and computer == "Paper":
        print("You Loss")

    elif user == "Rock" or "rock" or "ROCK" and computer == "Scissors":
        print("You Win")

    elif user == "Paper" or "paper" or "PAPER" and computer == "Paper":
        print("The Game is Tie.")

    elif user == "Paper" or "paper" or "PAPER" and computer == "Rock":
        print("You Win.")

    elif user == "Paper" or "paper" or "PAPER" and computer == "Scissors":
        print("You Loss.")

    elif user == "Scissors" or "scissors" or "SCISSORS" and computer == "Scissors":
        print("The Game is Tie.")

    elif user == "Scissors" or "scissors" or "SCISSORS" and computer == "Rock":
        print("You Loss.")

    elif user == "Scissors" or "scissors" or "SCISSORS" and computer == "Paper":
        print("You win.")
